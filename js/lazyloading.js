...
/* ------------------------------------------
 *  Перенесено из index.js                |
 *  И переписано в соответствии        |
 *  с правкой №6                          |
 *  -----------------------------------------
 *  Преобразование меню навигации     |
 *   при скролле страницы               |
 * ------------------------------------------
 */  
    if($(window).scrollTop() >= $("div.intro__buy").offset().top){
        $("header.header").addClass("-js-inner");
    }
    else{
        $("header.header").removeClass("-js-inner");
    }
